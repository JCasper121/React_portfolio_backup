...
export default class PortfolioForm extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            logo: "",
            editMode: false,
            apiUrl: "https://johncasper.devcamp.space/portfolio/portfolio_items",
            apiAction: 'post'
        };
        ...
        if(Object.keys(this.props.portfolioToEdit).length > 0) {
            const { id,
                ...
                this.setState({
                    ...
                    logo_url: logo_url || "",
                    editMode : true,
                    apiUrl: `https://johncasper.devcamp.space/portfolio/portfolio_items/${id}`,
                    apiAction: 'patch'
    ...
    handleSubmit(event) {
        ...
        axios({
            ...
            console.log("Portfolio submit error: ", err);
        });
